		...
		<div class="wrap repeater-wrap" data-name="<?php echo esc_attr( $alm_id ); ?>" data-type="unlimited">
			<div class="alm-row alm-row--margin-btm">
				...
				<div class="column column--half">
					<label class="template-title has-margin-btm" for="id-<?php echo esc_attr( $alm_id ); ?>">
						...
						<span><?php esc_attr_e( 'The unique ID assigned to this template (non-editable).', 'ajax-load-more-repeaters-v2' ); ?></span>
					</label>
			...
			<div class="alm-row">
				<div class="column">
					...
					<p class="alm-delete"><a href="javascript:void(0);"><?php esc_attr_e( 'Delete', 'ajax-load-more-repeaters-v2' ); ?></a></p>
				</div>
			</div>
		</div>
	</div>
