...
if(url!==permalink){almSinglePosts.setURL(id,permalink,title,page);}}};window.addEventListener('touchstart',almSinglePosts.onScroll);window.addEventListener('scroll',almSinglePosts.onScroll);window.almSetSinglePost=function(alm,id,permalink,title){almSinglePosts.titleTemplate=alm.addons.single_post_title_template;if(almSinglePosts.init){almSinglePosts.siteTitle=alm.addons.single_post_siteTitle;almSinglePosts.siteTagline=alm.addons.single_post_siteTagline;almSinglePosts.pageview=alm.addons.single_post_pageview;almSinglePosts.scroll=alm.addons.single_post_scroll;almSinglePosts.offset=parseInt(alm.addons.single_post_scroll_top);almSinglePosts.controls=alm.addons.single_post_controls;almSinglePosts.controls=(almSinglePosts.controls==='1')?true:false;almSinglePosts.scroll=(almSinglePosts.scroll==='true')?true:false;almSinglePosts.progress_bar=alm.addons.single_post_progress_bar;if(almSinglePosts.progress_bar!==''){almSinglePosts.almCreateProgressBar(almSinglePosts.progress_bar)}}
