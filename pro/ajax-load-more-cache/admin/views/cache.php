...
<div class="admin ajax-load-more alm-cache" id="alm-cache">
	<div class="wrap main-cnkt-wrap">
		<header class="header-wrap">
			<h1>
				<?php echo esc_attr( ALM_TITLE ); ?>: <strong><?php esc_attr_e( 'Cache', 'ajax-load-more-cache' ); ?></strong>
				<em><?php esc_attr_e( 'Manage your active Ajax Load More Cache', 'ajax-load-more-cache' ); ?></em>
			</h1>
		</header>
		<?php
			require_once ALM_CACHE_ADMIN_PATH . 'admin/views/includes/upgrade-notification.php';
			require_once ALM_CACHE_ADMIN_PATH . 'admin/views/includes/rest-api-test.php';
		?>
